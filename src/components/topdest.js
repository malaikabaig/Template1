...
export default function Blog() {
  ...
  return (
    <Box sx={{ backgroundColor: 'white !important', mb: -5 }}>
      <Box sx={{ mx: 'auto', py: 15, textAlign: 'center', maxWidth: 1200 }}>
        <Box>
          <Typography
            variant="h5"
            fontSize={35}
        ...
        <Grid container spacing={4} justifyContent="center" sx={{ mt: 7 }}>
          <Grid item xs={12} sm={6} md={3}>
            <Card variant="elevated">{card1}</Card>
          </Grid>
          <Grid item xs={12} sm={6} md={3}>
            <Card variant="elevated">{card2}</Card>
          </Grid>
          <Grid item xs={12} sm={6} md={3}>
            <Card variant="elevated">{card3}</Card>
          </Grid>
          <Grid item xs={12} sm={6} md={3}>
            <Card variant="elevated">{card4}</Card>
          </Grid>
        </Grid>
      </Box>
    </Box>
